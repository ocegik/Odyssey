...
const META = {
  [SYNC_STATUS.error]: { icon: TriangleAlert, label: "Sync failed", color: COLORS.danger, title: "Cloud sync is unavailable. Changes remain on this device; export a backup from Account." },
  ...
  [SYNC_STATUS.local]: { icon: HardDrive, label: "This device", color: COLORS.inkMuted, title: "Cloud sync is not configured. Data is stored in this browser; export backups from Account." },
