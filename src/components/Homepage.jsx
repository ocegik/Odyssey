      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="grid items-center gap-10 py-16 sm:py-24 lg:grid-cols-[1.1fr_.9fr] lg:gap-16">
          ...
          <aside className="rounded-2xl border p-6 sm:p-8" style={{ background: COLORS.surface, borderColor: COLORS.border, boxShadow: "var(--shadow-floating)" }} aria-labelledby="purpose-title">
            <p className="text-xs font-bold uppercase tracking-[0.16em]" style={{ color: COLORS.primary }}>Our purpose</p>
            <h2 id="purpose-title" className="mt-3 text-2xl font-bold tracking-tight" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
              Make preparation data useful.
            </h2>
            <p className="mt-4 text-sm leading-6" style={{ color: COLORS.inkMuted }}>
              Odyssey helps users turn their own mock-test results into a clear record of performance, areas to review, and work still to plan. The app supports study organisation; it does not provide official exam results, admissions advice, or score guarantees.
            </p>
          </aside>
        </section>
        ...
        <section className="border-t py-12 sm:py-16" style={{ borderColor: COLORS.border }} aria-labelledby="features-title">
          <div className="max-w-2xl">
            ...
            <h2 id="features-title" className="mt-3 text-3xl font-bold tracking-tight" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Tools for a more organised preparation routine.</h2>
          </div>
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            <Feature icon={BarChart3} title="Log mock tests">
              Record scores, attempts, accuracy, and section-level results for VARC, DILR, and Quant. Review trends from one mock to the next.
            </Feature>
            <Feature icon={BookOpenCheck} title="Track syllabus work">
              Keep a record of completed topics and identify areas that still need attention as your preparation develops.
            </Feature>
            <Feature icon={CalendarCheck2} title="Plan revisions">
              Set targets, organise study tasks, and use your past performance to guide the next revision session.
            </Feature>
          </div>
        </section>
        ...
        <section className="grid gap-6 border-t py-12 sm:grid-cols-[1fr_auto] sm:items-center" style={{ borderColor: COLORS.border }} aria-labelledby="account-title">
          <div>
            <h2 id="account-title" className="text-2xl font-bold tracking-tight" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Your preparation, in your account.</h2>
            <p className="mt-2 max-w-2xl text-sm leading-6" style={{ color: COLORS.inkMuted }}>
              Create an account to save your preparation data and return to it across sessions. Odyssey includes privacy and account controls for the information you add.
            </p>
          </div>
