...
export const SYLLABUS_SECTIONS = [
    ...
    macroTopics: [
      {
        ...
        microTopics: [
          ...
          {
            id: "varc-rc-structure-organization",
            name: "Structure / organization questions",
            category: "Question Types",
            frequency: "Medium",
            questionTypes: [
              "How the passage develops its argument or organizes ideas",
              "The function of a paragraph, example, or transition within the passage",
            ],
          },
          // A compact, high-coverage passage-topic vocabulary for RC analysis.
          { id: "varc-rc-history", name: "History", category: "Passage / Set Topics", questionTypes: ["Historical events, historiography, civilizations"] },
          { id: "varc-rc-society-culture", name: "Society & Culture", category: "Passage / Set Topics", questionTypes: ["Society, politics, law, culture, psychology, education"] },
          { id: "varc-rc-science", name: "Science", category: "Passage / Set Topics", questionTypes: ["Natural science, medicine, technology, environment"] },
          { id: "varc-rc-economics-business", name: "Economics & Business", category: "Passage / Set Topics", questionTypes: ["Economics, finance, markets, organizations"] },
          { id: "varc-rc-philosophy-abstract", name: "Philosophy & Abstract Ideas", category: "Passage / Set Topics", questionTypes: ["Ethics, logic, epistemology, abstract arguments"] },
          { id: "varc-rc-literature-arts", name: "Literature & Arts", category: "Passage / Set Topics", questionTypes: ["Literature, language, visual arts, aesthetics"] },
        ],
      },
      {
        id: "varc-va",
  ...
  },
  {
    ...
    macroTopics: [
      ...
      {
        id: "dilr-set-topics",
        name: "DILR Set Topics",
        weightageLabel: "Compact set-level classification for mock analysis",
        microTopics: [
          { id: "dilr-set-data-interpretation", name: "Data Interpretation", category: "Passage / Set Topics", questionTypes: ["Tables, charts, caselets, and data reconstruction"] },
          { id: "dilr-set-arrangements", name: "Arrangements & Distribution", category: "Passage / Set Topics", questionTypes: ["Seating, allocation, sequencing, and scheduling"] },
          { id: "dilr-set-games-tournaments", name: "Games & Tournaments", category: "Passage / Set Topics", questionTypes: ["Points tables, fixtures, brackets, and rankings"] },
          { id: "dilr-set-sets-venn", name: "Sets & Venn", category: "Passage / Set Topics", questionTypes: ["Set membership, overlaps, and inclusion-exclusion"] },
          { id: "dilr-set-reasoning-puzzles", name: "Reasoning Puzzles", category: "Passage / Set Topics", questionTypes: ["Constraint-based and conditional-logic puzzles"] },
          { id: "dilr-set-data-sufficiency", name: "Data Sufficiency", category: "Passage / Set Topics", questionTypes: ["Statement sufficiency and answerability"] },
          { id: "dilr-set-mixed", name: "Mixed / Hybrid", category: "Passage / Set Topics", questionTypes: ["Sets that deliberately combine DI and LR"] },
        ],
      },
      {
        id: "dilr-question-types",
        name: "DILR Question Types",
        weightageLabel: "Per-question classification for mock analysis",
        microTopics: [
          { id: "dilr-qt-data-extraction", name: "Data extraction", category: "Question Types", questionTypes: ["Read or locate the required value from the set"] },
          { id: "dilr-qt-calculation-comparison", name: "Calculation / comparison", category: "Question Types", questionTypes: ["Compute, compare, rank, or optimize a value"] },
          { id: "dilr-qt-logical-deduction", name: "Logical deduction", category: "Question Types", questionTypes: ["Derive a conclusion from the set's rules or constraints"] },
          { id: "dilr-qt-constraint-feasibility", name: "Constraint / feasibility", category: "Question Types", questionTypes: ["Test whether an arrangement, condition, or outcome is possible"] },
        ],
      },
    ],
  },
